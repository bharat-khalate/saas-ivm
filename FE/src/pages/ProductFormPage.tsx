  ...
  return (
    <div className='flex justify-center items-center min-h-100'>
      <div className=" md:w-1/2 ">
        <div className="mb-5 mx-auto w-40 flex items-center justify-between">
          ...
          >
            ...
            <FormField label="SKU">
              <input
                ...
                required
                className={inputClassName}
                style={{ cursor: mode === 'edit' ? 'not-allowed' : 'auto' }}
              />
              {validationErrors.sku && (
                <p className="text-red-500 text-sm">{validationErrors.sku}</p>
              )}
            </FormField>
            ...
            <FormField label="Quantity on hand">
              ...
              {validationErrors.quantityOnHand && (
                <p className="text-red-500 text-sm">{validationErrors.quantityOnHand}</p>
              )}
            </FormField>
            ...
            <FormField label="Cost price">
              ...
              {validationErrors.costPrice && (
                <p className="text-red-500 text-sm">{validationErrors.costPrice}</p>
              )}
            </FormField>
            ...
            <FormField label="Selling price">
              ...
              {validationErrors.sellingPrice && (
                <p className="text-red-500 text-sm">{validationErrors.sellingPrice}</p>
              )}
            </FormField>
            ...
            <FormField label="Low stock threshold">
              ...
              {validationErrors.lowStockThreshold && (
                <p className="text-red-500 text-sm">{validationErrors.lowStockThreshold}</p>
              )}
            </FormField>
