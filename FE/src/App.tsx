...
function AppShell() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      {user && (
        <header className="flex  min-w-fit items-center justify-between border-b border-slate-700/35 bg-gradient-to-br from-sky-500/12 via-transparent to-indigo-500/12 px-8 py-3 backdrop-blur-sm">
